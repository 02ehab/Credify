...
function smartReply(rawMsg) {
  ...
  const intents = [
    ...
    },
    {
      ...
      reply: () => ({
        html: `💰 View our individual pricing plans and features on the <a href="#pricing" target="_blank">Pricing</a> section. We offer flexible plans for individuals with different needs and budgets.`,
        suggestions: ["Compare Plans", "Individual Plans", "Free Trial", "Custom Pricing"]
      })
    },
    {
      name: "features",
    ...
    },
    {
      ...
      reply: () => ({
        html: `📞 Need personalized assistance? Contact our support team through the <a href="#contact" target="_blank">Contact</a> section or email us directly. Individual users get priority support and dedicated account managers.`,
